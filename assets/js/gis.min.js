...
if(moreOptionTaget){
	moreOptionTaget.addEventListener('click', () => {
...
//     tagBtns.addEventListener('mousedown', e => {
//       e.preventDefault(); // 阻止 button 搶走焦點
//     });

//     tagBtns.addEventListener('click', () => {
//       moreOptionTaget.focus(); // 點擊後強制把焦點還給 container
//     });
//   });
// });
